...
[Kurse auf LabEx erkunden](https://labex.io/de/learn/java)

|   Index | Kurs                                                                  | Schwierigkeit   | Repository                                               | Übung                                                         |
|---------|-----------------------------------------------------------------------|-----------------|----------------------------------------------------------|---------------------------------------------------------------|
|       1 | [Java für Anfänger](https://labex.io/de/courses/java-for-beginners)   | Anfänger        | [Repo](https://github.com/labex-labs/java-for-beginners) | [Lab starten](https://labex.io/de/courses/java-for-beginners) |
|       2 | [Java-Programmierübungen](https://labex.io/de/courses/java-exercises) | Anfänger        | [Repo](https://github.com/labex-labs/java-exercises)     | [Lab starten](https://labex.io/de/courses/java-exercises)     |
